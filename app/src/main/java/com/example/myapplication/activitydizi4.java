...
public class activitydizi4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activitydizi4);
    ...
    public void downLoadWithbytes1(){
        StorageReference imageRefl = storageReference.child("diziimage4.jpg");
        ...
        imageRefl.getBytes(MAXBYTES).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                DatabaseReference reference = database.getReference("dizisayfa/dizi4text");
