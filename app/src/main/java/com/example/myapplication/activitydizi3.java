...
public class activitydizi3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activitydizi3);
    ...
    public void downLoadWithbytes1(){
        StorageReference imageRefl = storageReference.child("diziimage3.jpg");
        ...
        imageRefl.getBytes(MAXBYTES).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                DatabaseReference reference = database.getReference("dizisayfa/dizi3text");
