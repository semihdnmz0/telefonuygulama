...
public class activityfilm5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityfilm5);
    ...
    public void downLoadWithbytes1(){
        StorageReference imageRefl = storageReference.child("filmimage5.jpg");
        ...
        imageRefl.getBytes(MAXBYTES).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                DatabaseReference reference = database.getReference("filmsayfa/film5text");
