...
public class activitydizi5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activitydizi5);
    ...
    public void downLoadWithbytes1(){
        StorageReference imageRefl = storageReference.child("diziimage5.jpg");
        ...
        imageRefl.getBytes(MAXBYTES).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                DatabaseReference reference = database.getReference("dizisayfa/dizi5text");
