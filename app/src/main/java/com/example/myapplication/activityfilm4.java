...
public class activityfilm4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityfilm4);
    ...
    public void downLoadWithbytes1(){
        StorageReference imageRefl = storageReference.child("filmimage4.jpg");
        ...
        imageRefl.getBytes(MAXBYTES).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                DatabaseReference reference = database.getReference("filmsayfa/film4text");
